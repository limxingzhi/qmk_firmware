...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_CAPS, KC_A,MT(MOD_LALT, KC_S), MT(MOD_LCTL, KC_D), MT(MOD_LGUI, KC_F),    LT(MAC_FN1,KC_G),   LT(MAC_FN1,KC_H), MT(MOD_RGUI, KC_J), MT(MOD_RCTL,KC_K),MT(MOD_RALT,KC_L),KC_SCLN,KC_QUOT,  KC_ENT,           KC_HOME,
    ...
    [MAC_FN1] = LAYOUT_69_ansi(
        ...
        BL_TOGG, BL_STEP,  BL_UP,    _______, _______, _______,           KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, KC_PGDN,  KC_END,   _______,          _______,
